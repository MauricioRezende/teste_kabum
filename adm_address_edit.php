...
<div style="padding-left: 5%; padding-right: 5%;">
	...
	<nav style="padding-left: 20px; border-radius: 10px;">
		<div class="nav-wrapper">
			<div class="col s12">
				...
				<a href="adm_client_edit.php?id=<?php echo $_GET["idc"]; ?>" class="breadcrumb">Editar cliente</a>
				<span class="breadcrumb">Editar endereço</span>
			</div>
		</div>
	</nav>
	<br />
	<form class="col s12" method="POST" action="">
				...
				if(sizeof($erro) > 0){
				    ...
				    <script type="text/javascript">
						swal("Alterado com sucesso!").then((click) => {
						  if (click) {
						    window.location = "adm_client_edit.php?id=<?php echo $_GET["idc"]; ?>";
						  }
						});
				    </script>
				    <?php
		...
		<div class="right-align">
			...
			<a href="./adm_client_edit.php?id=<?php echo $_GET["idc"]; ?>" class="btn" style="background-color: gray;">Voltar</a>
		</div>
	</form>
	<div class="row"></div>
</div>
